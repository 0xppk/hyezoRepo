 ...
 * )
 */
declare function useInput(submitAction?: (inputValue: string, ...args: unknown[]) => void, debounceTime?: number): readonly [string, ChangeEventHandler<HTMLInputElement>, () => void | Promise<any>, () => void];
