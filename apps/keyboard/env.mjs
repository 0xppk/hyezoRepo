...
const client = z.object({
  NEXT_PUBLIC_HYEZO_SECRET: z.string(),
  ...
  NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY: z.string(),
  NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY_ID: z.string(),
});
...
const processEnv = {
  ...
  NEXT_PUBLIC_HYEZO_SECRET: process.env.NEXT_PUBLIC_HYEZO_SECRET,
  ...
  NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY:
    process.env.NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY,
  NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY_ID:
    process.env.NEXT_PUBLIC_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY_ID,
};
